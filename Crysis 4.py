...
def  Lock_key():
   ...
   for i in key_list:
     camera.blit(GameKeyOff,i)
     if (x_cord, y_cord) == i:
        Keys -= 1
        camera.blit(GameKeyOn,(x_cord, y_cord))
...
lvl=1
list_of_lock =[[],[(1248,1088),(384,1056),(1728,800),(1984,640)],[(1216,416),(960,1120),(1920,1056)],[(1792,768),(1696,576),(3424,160)]]
key_list = list_of_lock[lvl]
GameKeyOn = load_image("GameKeyOn.png" )
GameKeyOff = load_image("GameKeyOff.png" )
...
gravity = 16
#Начальные корды
x_cord, y_cord = 704, 288
list_of_cords = [(0,0),(704, 288),(320, 256),(320, 288)]
